...
/**
 * 使用线程的方式，获取并显示CPU内存，
 * 在139在后台运行时，出现CPU占用率高，及对监控的package有影响
 * @author Administrator
 *
 */
public class ShowTimeSeriesChartsExample  extends JFrame {
	/**
	 * 
	 */
	...
	public ShowTimeSeriesChartsExample(){
    ...
    public static void main(String[] args) {
    	ShowTimeSeriesChartsExample example = new ShowTimeSeriesChartsExample();
