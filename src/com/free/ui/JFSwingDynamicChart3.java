...
public class JFSwingDynamicChart3 extends JFrame implements ActionListener {
...
//		// numberaxis.setTickUnit(new NumberTickUnit(10000));//Y轴数据间隔
	...
	public static void main(String[] args) {
		...
		JFSwingDynamicChart3 jsdChart = new JFSwingDynamicChart3();
